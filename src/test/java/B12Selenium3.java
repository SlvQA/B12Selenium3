...
//            System.out.println(expectedModelList);
            ...
            WebElement sortDropDown = driver.findElement(By.xpath("//select[@id='sort-by']"));
            ...
            for (WebElement p : findPrices) {
                String price = p.getText().split(" ")[0];
                price = price.replace("$", "").replace(",", "");
                pricesToVerify.add(Integer.parseInt(price));
                //System.out.println(pricesToVerify);
            }
            int int1;
            ...
            WebElement sortDropDown1 = driver.findElement(By.xpath("//select[@id='sort-by']"));
            Select select2 = new Select(sortDropDown1);
